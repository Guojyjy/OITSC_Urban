...
if __name__ == '__main__':
    ...
    env = UrbanEnvImplicitObservation(net_file=ABS_DIR + 'nets/1km/selected1km.net.xml',
                   ...
                   additional_sumo_cmd=['--tripinfo-output',
                                        'ImplicitObservation-QL-tripinfo-proposed-run1.xml'],
                   out_csv_name='ImplicitObservation-QL-output-proposed',
                   oitsc=True,
                   )
    ...
    for run in range(1, runs + 4):
        ...
        outfile = open('ImplicitObservation-QL-evaluation-proposed_run1.csv', 'w')
