...
from sumo_rl_rep.environment.env import UrbanEnv
...
if __name__ == '__main__':
    ...
    env = UrbanEnv(net_file=ABS_DIR + 'nets/1km/selected1km.net.xml',
                   ...
                   additional_sumo_cmd=['--tripinfo-output',
                                        'QL-tripinfo-ini-run1.xml'],
                   out_csv_name='QL-output-ini',
                   )
    ...
    for run in range(1, runs + 4):
        ...
        outfile = open('QL-evaluation-ini_run1.csv', 'w')
